...
public class MainActivity extends AppCompatActivity {
    ...
    private void createLoggerEntrys() {
        idx++;
        Logger.debug_addSeparatorLineWithMsgInCenter("BEGIN createLogger Entrys with idx[{}]",idx);
        for (int i = 0;i<1000;i++){
            Logger.debug("i have entry #[{}]",i);
        }
        Logger.debug_addSeparatorLineWithMsgInCenter("END createLogger Entrys");
    }
